...
public class updateInventory extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String manufacturerName = jTextField6.getText();
        String mdate = new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser2.getDate());
        String edate = new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser3.getDate());
        int quantity = (int) jSpinner1.getValue();
        int quantity_limit = (int) jSpinner2.getValue();
        ...
        try {
            ...
            ps = con.prepareStatement("UPDATE items SET productName=?, ProductCode=?, manufacturerName=?, mdate=?, edate=?, quantity=?, quantity_limit=?, price=? WHERE productId=?");
